...
Write-StartupDiagnostic "Startup architecture" "detached PowerShell; overlay mutex v260; build 2.6.0"

$createdNew = $false
$instanceMutex = New-Object System.Threading.Mutex(
    $true,
    "Local\TarteMeterOverlay_v260",
    [ref]$createdNew
)
if (-not $createdNew) {
    try {
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
 ...
 <Window.Resources>
  ...
  <Style x:Key="MeterRowStyle" TargetType="DataGridRow">
   ...
   <Style.Triggers>
    <Trigger Property="IsMouseOver" Value="True">
     ...
     <Setter Property="BorderBrush" Value="{DynamicResource ThemeMutedBrush}"/>
    </Trigger>
    <Trigger Property="IsSelected" Value="True">
     <Setter Property="Foreground" Value="#FFFFFF"/>
     <Setter Property="Background" Value="{DynamicResource ThemeSelectionBrush}"/>
     <Setter Property="BorderBrush" Value="{DynamicResource ThemeSelectionBorderBrush}"/>
     <Setter Property="BorderThickness" Value="1"/>
    </Trigger>
   </Style.Triggers>
  </Style>
  ...
  <Style x:Key="MeterGridStyle" TargetType="DataGrid">
   ...
   <Setter Property="RowBackground" Value="{DynamicResource ThemePanelAltBrush}"/>
   <Setter Property="AlternatingRowBackground" Value="{DynamicResource ThemePanelBrush}"/>
   <Setter Property="Foreground" Value="{DynamicResource ThemeTextBrush}"/>
 ...
 <Border CornerRadius="8"
  ...
  <Grid>
   ...
   <Grid Grid.Row="1" Margin="4,3,4,3">
    ...
    <Border Background="{DynamicResource ThemeSelectionBrush}"
            CornerRadius="7"
    ...
    <Grid Margin="6,3">
     ...
     <Border Grid.Column="1"
             Background="{DynamicResource ThemePanelAltBrush}"
             CornerRadius="6"
             Margin="3,0"
             Padding="6,3">
      <StackPanel>
    ...
    <TabItem Header="LOGS">
     <Grid Margin="2">
      ...
      <GridSplitter Grid.Row="1"
                    ...
                    Background="{DynamicResource ThemeSelectionBorderBrush}"/>
      ...
      <Grid Grid.Row="2">
       <Grid.RowDefinitions>
        ...
        <RowDefinition Height="4"/>
        <RowDefinition x:Name="LogTimelineRow"
                       Height="92"
                       MinHeight="58"
                       MaxHeight="320"/>
       </Grid.RowDefinitions>
       ...
       <GridSplitter x:Name="LogTimelineSplitter"
                     Grid.Row="3"
                     Height="4"
                     HorizontalAlignment="Stretch"
                     ...
                     ShowsPreview="True"
                     Background="{DynamicResource ThemeSelectionBorderBrush}"
                     ToolTip="Drag to resize the timeline"/>
       ...
       <Grid Grid.Row="4">
        ...
        <ScrollViewer x:Name="HistoryTimelineScroll"
                      ...
                      Background="{DynamicResource ThemeTrackBrush}">
     ...
     <ScrollViewer Grid.Row="1"
      ...
      <StackPanel>
       ...
       <TextBlock x:Name="HotkeyStatusText"
                  Text="Select a key binding, then apply it. F1-F12 and Ctrl/Shift/Alt combinations are supported."
                  TextWrapping="Wrap"
                  Foreground="{DynamicResource ThemeMutedBrush}"
                  FontSize="{DynamicResource MeterTextSmall}"
                  Margin="0,2,0,7"/>
...
function Process-OverlayShowRequest {
    ...
    try {
        ...
        [IO.File]::WriteAllText(
            $readyPath,
            ("TarteMeter v2.6.0 ready | " + [DateTime]::Now.ToString("o")),
            [Text.Encoding]::UTF8
        )
